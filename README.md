...
All wait times spefied above are maximum wait times. If a response is received earlier it should be
processed immediately for example, when sending the “AT” command the response is typically received
within 10 – 20ms.
...
- Module sends DevEui:
    +ID: DevEui, 2C:F7:F1:20:32:30:A5:
- Program prints:
    2cf7f1203230a
...
switch(state) {
case 1 :
_// do what needs to be done in state
// to change state assign a new value to 'state'_
break;
case 2 :
break;
case 3 :
